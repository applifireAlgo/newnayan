Ext.define('Mobilebp.view.smartdevice.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Mobilebp.view.smartdevice.design.drawer.main.MainPanelController','Mobilebp.view.smartdevice.design.resource.AppFormsList'],
    userinfo:{},
