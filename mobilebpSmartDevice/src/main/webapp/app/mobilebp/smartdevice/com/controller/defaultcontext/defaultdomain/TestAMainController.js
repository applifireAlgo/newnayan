Ext.define('Mobilebp.mobilebp.smartdevice.com.controller.defaultcontext.defaultdomain.TestAMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#TestATree');
          treePanel.collapse();
          var formPanel = this.getView().up().down('#TestA');
     ...
     loadData: function(responseData) {
          this.view.down('#TestA').getViewModel().setData(responseData.response.data);
     },
