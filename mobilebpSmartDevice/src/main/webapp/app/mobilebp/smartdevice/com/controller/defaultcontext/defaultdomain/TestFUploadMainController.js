Ext.define('Mobilebp.mobilebp.smartdevice.com.controller.defaultcontext.defaultdomain.TestFUploadMainController', {
     ...
     renderTreeGridData: function() {
          ...
          if (responseData.response.success) {
               ...
               if (responseData.response.exceptionId == 4005) {
                    var loginWindow = Ext.create('Mobilebp.view.login.SessionLogin').center();
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#TestFUploadTree');
          treePanel.collapse();
          var formPanel = this.getView().up().down('#TestFUpload');
     ...
     loadData: function(responseData) {
          this.view.down('#TestFUpload').getViewModel().setData(responseData.response.data);
     },
