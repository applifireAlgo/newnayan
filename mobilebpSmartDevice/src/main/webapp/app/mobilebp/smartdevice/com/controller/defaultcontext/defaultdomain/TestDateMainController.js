Ext.define('Mobilebp.mobilebp.smartdevice.com.controller.defaultcontext.defaultdomain.TestDateMainController', {
     extend: 'Mobilebp.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.TestDateMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#TestDateTree');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#TestDate');
          var grid = this.view.down('#TestDateGrid');
          var tree = this.view.down('#TestDateTreeContainer');
          grid.setHidden(true);
     ...
     renderTreeGridData: function() {
          ...
          if (responseData.response.success) {
               ...
               tree.getStore().sort('text', 'ASC');
               var compRef = this.view.down('#TestDateTree');
          } else {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#TestDateTree');
          treePanel.collapse();
          var formPanel = this.getView().up().down('#TestDate');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestDate').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#TestDateGrid').store;
          gridStore.removeAll();
     ...
     loadData: function(responseData) {
          this.view.down('#TestDate').getViewModel().setData(responseData.response.data);
     },
