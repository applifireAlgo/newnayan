Ext.define('Mobilebp.mobilebp.smartdevice.com.controller.defaultcontext.defaultdomain.ChildMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#ChildTree');
          treePanel.collapse();
          var formPanel = this.getView().up().down('#Child');
     ...
     loadData: function(responseData) {
          this.view.down('#Child').getViewModel().setData(responseData.response.data);
     },
