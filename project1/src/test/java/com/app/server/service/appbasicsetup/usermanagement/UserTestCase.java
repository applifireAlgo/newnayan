...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelName("ECN9SbwhY0XPVdkqiHJ44U4d7BnmFsr3sWoH3OE3dxFt4LDQWj");
        useraccesslevel.setLevelHelp("R3c9j9qDm0iLwjsdMewSoX000qdy9JD6eFeJVt0ccGaQLzHjgs");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelDescription("iN6UungD6iWZLmmz68YrzihtDJnS9eo849S8jKHxZitKGfbP1i");
        useraccesslevel.setLevelIcon("lBgMrasCO86eKPvCgb2OcR9nScwuOUMFKpptL40akNwrF7u8ys");
        ...
        useraccessdomain.setDomainIcon("yxJ3uFBnnyHy9Y7C1eAfB4yrL4RdAXs3MM6i6AhZHaqPK6YV9p");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("uZJlPPd3WABFXfDlKGFNhMFwz8VjQuMbEzLHyIQNgr83cXp4MS");
        useraccessdomain.setDomainName("GXO6vXYgv3BVIMmQmnqOsqi1dhRHBnx5dKIxVWyAKuFlUtHuku");
        useraccessdomain.setDomainDescription("J9TJPyjZoOZbgvmedDksK8aefeTfRVrWV1h108Defk1jotoqIK");
        ...
        user.setSessionTimeout(127);
        user.setUserAccessCode(48793);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1463464660893l));
        user.setPasswordAlgo("odYxVrVBdJ3vCv1IEzStsNuU9cyPJlLVHwbV2HdKx11Zcp1TV1");
        user.setPasswordExpiryDate(new java.sql.Timestamp(1463464660893l));
        ...
        passrecovery.setAnswer("9HxHFCg0JkehS4HoeIjvd98eFKP2MWzl4TAJi3UAVRhagJ5B4Z");
        Question question = new Question();
        question.setLevelid(6);
        question.setQuestionDetails("Dgd8z1jY3v");
        question.setQuestion("JwDCRKWOW6Ckz9o5LwmNXuFktj9dExlmywA3QN2NDrNaqjludS");
        question.setQuestionIcon("mBUMj1zArTmCLh95pLGUYQ7aEiLaWBhsDgwQAyNdbmPfC5EE6K");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("NJzlWdJdWkq8vJYTwwk9aMBdthdeICtpYieWr29cNWcHrm5sQ5");
        ...
        userdata.setPassword("5hWxG6ww3Mdkoxu1iqqX9O8g2aSQ5zmV9GtoNUwDnnyHV8z0ke");
        userdata.setOneTimePassword("P8RnT7f5pckXXDpguChnJtSw42dhGiX3");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1463464662278l));
        userdata.setLast5Passwords("huNR0loRS2dXww07RvC5SUrvRuHlEoHLxpLl7Vycuka8alT7mb");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 67152));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "6X8m5uHfbyC0rocY13Ck1yjmDhDJbkWJXmKVv9DZN8mf5uwBd5z7oGRXH8mnDAVrV"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5029));
