...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("pu9ZbL93AY");
        question.setQuestion("OJUNpUA4zJZSMKI7g7CKt2WccZoSbquQ4UzxwxskcxgdYDHBRD");
        question.setQuestionIcon("tUArAH2jBJ0gAEazTXlBbk0GbVeAnrugzLKVjPMPA78mb69Ouj");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("fNTaDkOAVP");
            question.setVersionId(1);
            question.setQuestion("cZqDAKBN8v5ZD30MNRDs3CXGWfdXRmIQxmkCWSwNCfpKEFRnVU");
            question.setQuestionIcon("jtg6599532LivJx4Wa47IccvaMJOGaChHxzjZemiilLF4VHTOl");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "L4DwX2NgX5JBKS0Vd1thJKPpyAvVKWphfy9qYtDykLQ6QhwZnqEbQN0yqEIpYWNGq"));
