package com.app.server.businessservice.testboundedcontext.testdomain.aspect;
...
@Aspect
@Component
public class BusinessServicetestdomainAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.testboundedcontext.testdomain..*(..))")
    ...
    public Object aroundfindAll(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Object object = null;
        try {
            Log.out.println("TBCTD317100100", runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), joinPoint.getSignature().getDeclaringTypeName() + ":" + joinPoint.getSignature().getName());
            ...
            businessException.getException("TBC", "TD", e, runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint);
        } finally {
