...
public class BusinessServicesampledomainAspect extends BusinessAspect {
    ...
    public Object aroundfindAll(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Object object = null;
        try {
            Log.out.println("GGTHH317100100", runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), joinPoint.getSignature().getDeclaringTypeName() + ":" + joinPoint.getSignature().getName());
            ...
            businessException.getException("GGT", "HH", e, runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint);
        } finally {
