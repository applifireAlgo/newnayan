...
@Repository
@SourceCodeAuthorClass(createdBy = "nayan.chaudhari@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for TestB Transaction table", complexity = Complexity.MEDIUM)
public class TestBRepositoryImpl extends SearchInterfaceImpl implements TestBRepository<TestB> {
    ...
    @Transactional
    public TestB findById(String tid) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
