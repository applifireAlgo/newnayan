...
@SourceCodeAuthorClass(createdBy = "nayan.chaudhari@algorhythm.co.in", updatedBy = "nayan.chaudhari@algorhythm.co.in", versionNumber = "4", comments = "Employee", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "Employee.findById", query = "select e from Employee e where e.systemInfo.activeStatus=1 and e.empId =:empId") })
