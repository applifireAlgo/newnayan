Ext.define('Project1.view.desktop.design.drawer.main.MainPanelController', {
    ...
    loadLangCombo : function(){
     ...
     onSearchClick : function(searchBtn){
        ...
        var langCmb=this.getView().down('#Lang');
        searchView.controller.doSearch(searchView,searchTxt.getValue(),langCmb.getValue());
