Ext.define('Project1.project1.web.com.controller.sampleboundedcontext.sampledomain.EmployeeMainController', {
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#EmployeeGrid').store;
          gridStore.removeAll();
