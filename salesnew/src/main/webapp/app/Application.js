 ...
 */
Ext.define('Salesnew.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Salesnew.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Salesnew.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Salesnew.view.login.SessionLogin').center();
