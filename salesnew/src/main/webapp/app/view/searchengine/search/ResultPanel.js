Ext
		.define(
				'Salesnew.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Salesnew.view.searchengine.search.SearchEngineMainPanelController','Salesnew.view.searchengine.search.PanelHeaderField' ,'Salesnew.view.searchengine.search.ReportGridView','Salesnew.view.searchengine.search.ReportChartView','Salesnew.view.searchengine.search.documentView','Salesnew.view.searchengine.search.DouMeanView','Salesnew.view.googlemaps.map.MapPanel'],
