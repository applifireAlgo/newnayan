Ext.define('Salesnew.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Salesnew.view.searchengine.search.NorthPanel', 'Salesnew.view.searchengine.search.SearchResult','Salesnew.view.searchengine.search.SearchEngineMainPanelController'],
