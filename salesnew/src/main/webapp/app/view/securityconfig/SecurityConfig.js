 ...
 * 
 */
Ext.define('Salesnew.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Salesnew.view.securityconfig.SecurityConfigController',
			'Salesnew.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
