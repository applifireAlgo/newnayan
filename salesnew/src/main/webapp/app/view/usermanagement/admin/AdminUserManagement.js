Ext.define('Salesnew.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Salesnew.view.usermanagement.admin.UserPasswordReset',
	            'Salesnew.view.usermanagement.admin.AddUserDetails',
	            'Salesnew.view.usermanagement.admin.ViewUser'],
