Ext.define('Salesnew.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Salesnew.view.usermanagement.admin.AddUserDetailsViewModel', 'Salesnew.model.AddUserDataModel' ],
