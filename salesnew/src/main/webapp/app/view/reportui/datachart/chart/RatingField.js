...
Ext.define('Salesnew.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Salesnew.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Salesnew.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
