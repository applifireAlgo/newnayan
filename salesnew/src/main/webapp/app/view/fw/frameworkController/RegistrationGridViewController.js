Ext.define('Salesnew.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Salesnew.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Salesnew.view.console.ConsoleWindow');
