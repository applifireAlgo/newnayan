 ...
 */
Ext.define('Salesnew.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Salesnew.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Salesnew.view.fw.component.DateTimePicker(o);
    },
