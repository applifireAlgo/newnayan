 ...
 * 
 */
Ext.define('Salesnew.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Salesnew.view.logalarm.mainscreen.AddLogAlarmController',
			'Salesnew.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Salesnew.view.logalarm.mainscreen.AppAlarmPanel',
