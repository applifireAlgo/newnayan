...
Ext
		.define(
				'Salesnew.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Salesnew.view.logger.tabs.details.DetailsTab',
							'Salesnew.view.logger.tabs.fileconnector.FileConnectorTab',
							'Salesnew.view.logger.tabs.dbconnector.DBConnectorTab',
							'Salesnew.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Salesnew.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Salesnew.view.logger.LogConfigurationTabPanelController',
