 ...
 * 
 */
Ext.define('Salesnew.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Salesnew.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
