...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccessdomain.setDomainIcon("soYCSHl0ZrqxFmmtpOL5wEXwEdC2zH8T6hjyRve1GuyfXWxZmm");
        useraccessdomain.setDomainName("8xzxqbRlXLVN7Mkk6R9ML9GojrDqhwsJtECbu8mr1qByfIrThR");
        useraccessdomain.setDomainDescription("X3EGTTq0ytmfLQAhsBiV7IaRaZEYMYUTeyF6nJOva0OWVwAPed");
        useraccessdomain.setDomainHelp("yuCrTMFxEYLbjS8FTwYC5M6B6jbpi87Y207V5mfzGZowFbgPUy");
        ...
        useraccesslevel.setLevelIcon("hk3BLLYAyFtBPZeo5Apmq2wqHlCMMfgJk5WkFmVJf2sQ8MEg1g");
        useraccesslevel.setLevelDescription("2y1zqIqcdrtybrd1XYRHi7eyd7UwGQNzuYv16qw1X56tVi9Ory");
        useraccesslevel.setLevelName("oSOnuBRkkx03jHer2FwbnCxT08LZCuanDWKKYLNTWBDrZMOgbW");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("93aVGa43VUyecKHuCrqCq4glb81FMsVfLYxeWyM5jmiGcb6lH4");
        ...
        User user = new User();
        user.setPasswordAlgo("hWRWvpV2CRpGWiuLtCOWbNyhkDVdlycFUsPJfEr4VOPqhc5d8n");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setMultiFactorAuthEnabled(1);
        user.setGenTempOneTimePassword(1);
        user.setUserAccessCode(28406);
        user.setIsLocked(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setSessionTimeout(2150);
        user.setAllowMultipleLogin(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459405516979l));
        user.setChangePasswordNextLogin(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459405516979l));
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("skt2HwsHma");
        question.setLevelid(3);
        question.setQuestionIcon("6ZyqynaTOBifpGENQ0QG11WoRIfPXLcYh39icJ0kTufITWSeR3");
        question.setQuestion("QCiTq8WNwBf4RmxxLVTORUwLf80cPhcdvALKpxbbO52U06mAQa");
        ...
        passrecovery.setAnswer("NavB2lwmKmDBTHWvkWkFLIOkPsr2c8dj9pIkvpONLdcNn6uYQQ");
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459405517050l));
        userdata.setOneTimePassword("NBpoFHAG7glthBPApCuvg05Gjp7OFiuE");
        userdata.setPassword("MNIUYFzBORuPEHNCQzMgtX6zqz2RLa40FRCTVf5XiGfYXubtTO");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459405517056l));
        userdata.setOneTimePassword("GMUeTmpVLXV4QxU9oWRyCuTY9mlUT1LI");
        userdata.setPassword("byzCKMYZzGpdr8O7vgpGVTLeVwGteZczJsj0dPcyeM9N5Epoav");
        userdata.setUser(user);
        userdata.setOneTimePasswordExpiry(2);
        userdata.setLast5Passwords("3IrPL4o3PgMCmVxNZlmlUBTIXjUE3MWXqqNUbCZKhUNeouuKTS");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 95238));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "RDhO7kGV2b5Zbid68eemctFdDdCMZHCw2Id3BxdKDyQZShAh2WEvwuRrqVabpTn2W"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5113));
