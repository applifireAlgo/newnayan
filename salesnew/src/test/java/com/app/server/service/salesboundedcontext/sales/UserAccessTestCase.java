...
public class UserAccessTestCase extends EntityTestCriteria {
    ...
    private UserAccess createUserAccess(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        salesregion.setRegionname("PaeieHpVAX0Z3thcPGUuWFNhxmoNkchOACfiXPped6EPm8C68f");
        ...
        User user = new User();
        user.setPasswordAlgo("yRdm6FX3bT22R1laIL2OD6Jfg9BlQbXrOj6p0vu9Y3cMMbR87y");
        UserAccessDomain useraccessdomain = new UserAccessDomain();
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainIcon("870XnxacelPsmt42rJgVssMM9zvkUdnd8sMYLvBJJunMN1pt6B");
        useraccessdomain.setDomainName("uYZNvyyTEztaiylg1T1oldvJyv5a5OxdPsjJRfUsczHRPSP3Ze");
        useraccessdomain.setDomainDescription("gz3YynFdgSqvcxPRvvZpXqH3ZucH2iO6CQuioS01HDhISW6O4O");
        useraccessdomain.setDomainHelp("YAybsjp2A1fXIL7Mr988NuCjxnHhOGELdahXgmlaaBjKfWtWNZ");
        ...
        useraccesslevel.setLevelIcon("HAAUw7RLvbLdXK6JuDVb6uDTKizQS606xArMI98qEYX9ZNWcj1");
        useraccesslevel.setLevelDescription("rxfjbZS7Maozetk8Ewf9Xw2GCKwojXOxyLtUrzKfOVZOJq4Vju");
        useraccesslevel.setLevelName("cI9WPlNjEymaLs0UgYLJb1mnPUjxiNYxFLLTOKu14xzjMCvUU2");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("5WVXcVwtTZBAncG3UzT0Iijlla5ytSICOo277R5u2lLrkHhfNb");
        UserAccessLevel UserAccessLevelTest = new UserAccessLevel();
        if (isSave) {
            UserAccessLevelTest = useraccesslevelRepository.save(useraccesslevel);
            map.put("UserAccessLevelPrimaryKey", useraccesslevel._getPrimarykey());
        }
        user.setPasswordAlgo("IaIXkRX2jKftR71QsWmHhgReVeAqGOJDNfkh2zsEf5UtoldcM3");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setMultiFactorAuthEnabled(1);
        user.setGenTempOneTimePassword(1);
        user.setUserAccessCode(49976);
        user.setIsLocked(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setSessionTimeout(298);
        user.setAllowMultipleLogin(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459405532061l));
        user.setChangePasswordNextLogin(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459405532061l));
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("gkLAj7HCuG");
        question.setLevelid(6);
        question.setQuestionIcon("3FOqcG7ELT8o9zwwfV7F5FkgyU0kWlTAov3Fx5g2356XRIXFcD");
        question.setQuestion("sDAFfqRO6JlbskybMg4yjFbimg3w5niWVMnSxqxln4Jy04eZdw");
        ...
        passrecovery.setAnswer("GdROIMM0f2CAR9HVqCvGrw3g1MVtbutMElBlN3S1UwmgQd2NgQ");
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459405532160l));
        userdata.setOneTimePassword("SpdzBEuapIDiIWByTYafn4ljdhLIu7hV");
        userdata.setPassword("WA4VDEVGfNhNVnqB11fQEa1ECX3XiDqSTk9biVPyzZ7ghYq7dc");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459405532164l));
        userdata.setOneTimePassword("sfh1yLMr67hcsk4BeCnmTC3DZ3s3ZG44");
        userdata.setPassword("vg9YKePmL7NzMN4bxdOUGgxYNJgzqd7eiSbkoU1c3KnWfovOZj");
        userdata.setUser(user);
        userdata.setOneTimePasswordExpiry(6);
        userdata.setLast5Passwords("uR9Nf47ycszDCOVc74XOTRobMyYvdHNg62aJ5RphXzRUVEyP4y");
