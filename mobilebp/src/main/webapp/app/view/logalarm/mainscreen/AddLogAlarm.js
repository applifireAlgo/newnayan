 ...
 * 
 */
Ext.define('Mobilebp.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Mobilebp.view.logalarm.mainscreen.AddLogAlarmController',
			'Mobilebp.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Mobilebp.view.logalarm.mainscreen.AppAlarmPanel',
