 ...
 * 
 */
Ext.define('Mobilebp.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Mobilebp.view.securityconfig.SecurityConfigController',
			'Mobilebp.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
