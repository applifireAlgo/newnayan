 ...
 */
Ext.define('Mobilebp.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Mobilebp.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Mobilebp.view.fw.component.DateTimePicker(o);
    },
