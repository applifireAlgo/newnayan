Ext.define('Mobilebp.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Mobilebp.view.usermanagement.admin.AddUserDetailsViewModel', 'Mobilebp.model.AddUserDataModel' ],
