Ext.define('Mobilebp.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Mobilebp.view.usermanagement.admin.UserPasswordReset',
	            'Mobilebp.view.usermanagement.admin.AddUserDetails',
	            'Mobilebp.view.usermanagement.admin.ViewUser'],
