 ...
 * 
 */
Ext.define('Mobilebp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Mobilebp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
