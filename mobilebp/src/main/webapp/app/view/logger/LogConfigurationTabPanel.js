...
Ext
		.define(
				'Mobilebp.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Mobilebp.view.logger.tabs.details.DetailsTab',
							'Mobilebp.view.logger.tabs.fileconnector.FileConnectorTab',
							'Mobilebp.view.logger.tabs.dbconnector.DBConnectorTab',
							'Mobilebp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Mobilebp.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Mobilebp.view.logger.LogConfigurationTabPanelController',
