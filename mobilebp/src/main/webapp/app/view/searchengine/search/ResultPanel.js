Ext
		.define(
				'Mobilebp.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Mobilebp.view.searchengine.search.SearchEngineMainPanelController','Mobilebp.view.searchengine.search.PanelHeaderField' ,'Mobilebp.view.searchengine.search.ReportGridView','Mobilebp.view.searchengine.search.ReportChartView','Mobilebp.view.searchengine.search.documentView','Mobilebp.view.searchengine.search.DouMeanView','Mobilebp.view.googlemaps.map.MapPanel'],
