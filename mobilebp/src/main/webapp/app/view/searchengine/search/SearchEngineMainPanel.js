Ext.define('Mobilebp.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Mobilebp.view.searchengine.search.NorthPanel', 'Mobilebp.view.searchengine.search.SearchResult','Mobilebp.view.searchengine.search.SearchEngineMainPanelController'],
