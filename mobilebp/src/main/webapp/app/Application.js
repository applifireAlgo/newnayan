 ...
 */
Ext.define('Mobilebp.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Mobilebp.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Mobilebp.store.QueryCriteriaWidgetsStore' ],
