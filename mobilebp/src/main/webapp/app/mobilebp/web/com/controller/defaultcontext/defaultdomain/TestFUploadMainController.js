Ext.define('Mobilebp.mobilebp.web.com.controller.defaultcontext.defaultdomain.TestFUploadMainController', {
     extend: 'Mobilebp.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.TestFUploadMainController',
     init: function() {
          var form = this.view.down('#TestFUploadForm');
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#TestFUploadTree');
               ...
               var compRef = this.view.down('#TestFUploadTree');
     ...
     resetForm: function(but) {
          ...
          form.down('#saveFormButton').setText('Save');
          form.reset();
          var grid = this.view.down('#TestFUploadGrid');
          var tree = this.view.down('#TestFUploadTree');
          tree.setSelection();
          grid.setSelection();
     },
     hideDataBrowser: function() {
          var form = this.view.down('#TestFUpload');
          var grid = this.view.down('#TestFUploadGrid');
          var tree = this.view.down('#TestFUploadTreeContainer');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#TestFUploadForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#TestFUploadTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var TestFUpload = this.view.down('#TestFUploadForm');
               TestFUpload.reset();
               var gridPanel = this.view.down('#TestFUploadGrid');
          ...
          var formPanel = this.getView().up().down('#TestFUploadForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#TestFUploadTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestFUpload').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#TestFUploadGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
