Ext.define('Mobilebp.mobilebp.web.com.controller.defaultcontext.defaultdomain.ParentMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#ParentForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#ParentForm');
          var grid = this.view.down('#ParentGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#ParentGrid');
               ...
               var formPanel = this.getView().up().down('#ParentForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#ParentTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#ParentForm').down('#' + me.column.dataIndex + '').store;
