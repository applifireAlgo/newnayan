Ext.define('Mobilebp.mobilebp.web.com.controller.defaultcontext.defaultdomain.TestDateMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#TestDateForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#TestDateForm');
          var grid = this.view.down('#TestDateGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#TestDateGrid');
               ...
               var formPanel = this.getView().up().down('#TestDateForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#TestDateTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestDateForm').down('#' + me.column.dataIndex + '').store;
