...
import com.app.server.businessservice.defaultcontext.defaultdomain.FNew;
...
@RequestMapping("/FNewWS")
public class FNewWS {

    @Autowired
    private FNew fnew;

    @RequestMapping(value = "/proFNew", consumes = "application/json", method = RequestMethod.POST)
    public HttpEntity<ResponseBean> proFNew(@RequestBody NewDto dt) throws Exception, SpartanBusinessValidationFailedException, SpartanDataNotFoundException, SpartanIncorrectDataException, SpartanPersistenceException {
