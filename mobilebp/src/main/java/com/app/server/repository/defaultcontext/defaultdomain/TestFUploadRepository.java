...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for TestFUpload Transaction table", complexity = Complexity.MEDIUM)
public interface TestFUploadRepository<T> extends SearchInterface {
    ...
    public T findById(String tfId) throws Exception, SpartanPersistenceException;
}
