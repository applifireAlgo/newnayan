...
@Table(name = "ast_Parent_M")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Parent", complexity = Complexity.LOW)
...
public class Parent implements Serializable, CommonEntityInterface, Comparator<Parent> {
    ...
    public void setpNo(Integer _pNo) {
        if (_pNo != null) {
            this.pNo = _pNo;
        }
    }
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.defaultcontext.defaultdomain.Parent other = (com.app.shared.defaultcontext.defaultdomain.Parent) obj;
            if (pId == null) {
                return false;
