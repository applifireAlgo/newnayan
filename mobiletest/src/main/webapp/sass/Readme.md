...
folder are mapped to the application's root namespace, 'Mobiletest'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Mobiletest' in the same way
as `"Mobiletest/sass/src"`.
