 ...
 */
Ext.define('Mobiletest.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Mobiletest.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Mobiletest.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Mobiletest.view.login.SessionLogin').center();
