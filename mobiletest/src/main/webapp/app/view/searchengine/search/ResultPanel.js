Ext
		.define(
				'Mobiletest.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Mobiletest.view.searchengine.search.SearchEngineMainPanelController','Mobiletest.view.searchengine.search.PanelHeaderField' ,'Mobiletest.view.searchengine.search.ReportGridView','Mobiletest.view.searchengine.search.ReportChartView','Mobiletest.view.searchengine.search.documentView','Mobiletest.view.searchengine.search.DouMeanView','Mobiletest.view.googlemaps.map.MapPanel'],
