Ext.define('Mobiletest.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Mobiletest.view.usermanagement.enduser.UserProfileController', 'Mobiletest.view.usermanagement.admin.AddUserDetailsViewModel', 'Mobiletest.model.AddUserDataModel' ],
