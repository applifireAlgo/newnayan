Ext.define('Mobiletest.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Mobiletest.view.usermanagement.admin.UserPasswordReset',
	            'Mobiletest.view.usermanagement.admin.AddUserDetails',
	            'Mobiletest.view.usermanagement.admin.ViewUser'],
