Ext.define('Mobiletest.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Mobiletest.view.usermanagement.admin.AddUserDetailsViewModel', 'Mobiletest.model.AddUserDataModel' ],
