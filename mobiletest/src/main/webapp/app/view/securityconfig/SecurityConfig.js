 ...
 * 
 */
Ext.define('Mobiletest.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Mobiletest.view.securityconfig.SecurityConfigController',
			'Mobiletest.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
