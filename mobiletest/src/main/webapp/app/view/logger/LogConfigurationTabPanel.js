...
Ext
		.define(
				'Mobiletest.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Mobiletest.view.logger.tabs.details.DetailsTab',
							'Mobiletest.view.logger.tabs.fileconnector.FileConnectorTab',
							'Mobiletest.view.logger.tabs.dbconnector.DBConnectorTab',
							'Mobiletest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Mobiletest.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Mobiletest.view.logger.LogConfigurationTabPanelController',
