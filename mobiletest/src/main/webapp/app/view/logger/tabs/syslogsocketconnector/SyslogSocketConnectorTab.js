 ...
 * 
 */
Ext.define('Mobiletest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Mobiletest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
