 ...
 * 
 */
Ext.define('Mobiletest.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Mobiletest.view.logalarm.mainscreen.AddLogAlarmController',
			'Mobiletest.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Mobiletest.view.logalarm.mainscreen.AppAlarmPanel',
