 ...
 * 
 */
Ext.define('Mobiletest.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Mobiletest.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
