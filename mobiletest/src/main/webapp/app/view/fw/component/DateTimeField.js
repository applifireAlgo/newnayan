 ...
 */
Ext.define('Mobiletest.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Mobiletest.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Mobiletest.view.fw.component.DateTimePicker(o);
    },
