 ...
 * 
 */
Ext.define("Mobiletest.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Mobiletest.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
