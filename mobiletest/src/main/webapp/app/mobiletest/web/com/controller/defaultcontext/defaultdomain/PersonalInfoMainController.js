Ext.define('Mobiletest.mobiletest.web.com.controller.defaultcontext.defaultdomain.PersonalInfoMainController', {
     extend: 'Mobiletest.view.fw.frameworkController.FrameworkViewController',
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#PersonalInfoForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#PersonalInfoForm');
          var grid = this.view.down('#PersonalInfoGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#PersonalInfoForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#PersonalInfoForm').down('#' + me.column.dataIndex + '').store;
