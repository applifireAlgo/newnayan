...
@RestController
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "4", comments = "Service for PersonalInfo Master table Entity", complexity = Complexity.LOW)
...
public class PersonalInfoServiceImpl extends PersonalInfoService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.defaultcontext.defaultdomain.PersonalInfo> lstpersonalinfo = personalInforepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.defaultcontext.defaultdomain.PersonalInfo lstpersonalinfo = personalInforepo.findById((java.lang.Integer) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstpersonalinfo);
        } catch (org.springframework.transaction.TransactionException e) {
