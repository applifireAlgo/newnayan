...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestion("TGftJdOyKGlYe9D8BO6UC5BEJnHzLnwvP0n1qOS7nM5tcju5Rs");
        question.setQuestionIcon("7WEYH00PaVzrwRtWbnzGGIoNIttmJ1J4FPfmsZdgMXVwvc4Jbe");
        question.setQuestionDetails("g6Rlm9b3r7");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("XcOw86u0OHGsUEf8xqpvkuvnOK0RX4VGkAdYOyv9jU1Kuc21Cf");
            question.setQuestionIcon("d8xPQLSDz1JrtLuUqBy5XoH2djAe42QwRyxK4m6ENhHnnSOGMu");
            question.setQuestionDetails("zdYDNwDL1b");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "eoQ9W1X0ZVOMNKgaskVLNqyYhbyqadZQ3sn1RJlFlmegocE9SW9VfjpZjukif5Dyc"));
